# zkUtil [![Build Status](https://travis-ci.org/poma/zkutil.svg?branch=master)](https://travis-ci.org/poma/zkutil) [![Crates.io](https://img.shields.io/crates/v/zkutil.svg)](https://crates.io/crates/zkutil)
